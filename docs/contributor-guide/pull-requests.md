...
If you are looking for ideas of what to work on, check [the list of open issue reports](https://github.com/per1234-org/repo-list/issues). Pull requests addressing any of those bug reports and feature requests are welcome.
...
https://github.com/per1234-org/repo-list/issues?q=
...
It is possible that the maintainers may decide a pull request doesn't align with our goals for the project and close it rather than merging. A record of the proposed changes will always be available on GitHub for future reference. If you think your modifications will be of use to others, you are welcome to maintain your own fork of the repository.
